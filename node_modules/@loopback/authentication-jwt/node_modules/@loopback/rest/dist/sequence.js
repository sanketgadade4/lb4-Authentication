 ...
 */
let MiddlewareSequence = class MiddlewareSequence {
    /**
     ...
     */
    constructor(invokeMiddleware, options = MiddlewareSequence.defaultOptions) {
...
MiddlewareSequence = tslib_1.__decorate([
    tslib_1.__param(0, core_1.inject(keys_1.RestBindings.INVOKE_MIDDLEWARE_SERVICE)),
