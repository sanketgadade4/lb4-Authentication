...
function invokeMiddleware(middlewareCtx, options) {
    ...
    const order = group_sorter_1.sortListOfGroups(orderedGroups, ...ordersFromDependencies);
    const mwChain = new types_1.MiddlewareChain(middlewareCtx, filter, core_1.compareBindingsByTag('group', order));
