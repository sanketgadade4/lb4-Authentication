...
//import {OAUTH_PROVIDERS_LOCATION} from '..oauth2-providers.json/google'
...
async function main() {
    let oauth2Providers;
    let OAUTH_PROVIDERS_LOCATION = '../oauth2-providers.json';
    if (OAUTH_PROVIDERS_LOCATION) {
        oauth2Providers = require(OAUTH_PROVIDERS_LOCATION);
    }
    else {
